...
#'
#' @param m Lower bound of the interval on which to define the basis functions. By default, 0.
#'
#' @param M Upper bound of the interval on which to define the basis functions. By default, 1.
#'
