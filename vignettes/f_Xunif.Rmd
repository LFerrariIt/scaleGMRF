...
`"rw1"` implements a random walk process of order 1 which is often used to model temporal effects. The model is an IGMRF of order 1 where the precision matrix is defined as: $$                                $$ see Equation 3.22 of Rue & Held, 2005.
...
`"rw2"` implements a random walk process of order 2 which is often used to model temporal effects. The model is an IGMRF of order 2 where the precision matrix is defined as: $$                                $$ see Equation 3.40 of Rue & Held, 2005.
